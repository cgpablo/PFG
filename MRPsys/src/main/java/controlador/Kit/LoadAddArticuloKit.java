 ...
 */
@WebServlet("/pages/LoadAddArticuloKit")
public class LoadAddArticuloKit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadAddArticuloKit() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/pages/verAddArticuloKits.jsp").forward(request, response);
	}
