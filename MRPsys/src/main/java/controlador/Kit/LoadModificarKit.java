 ...
 */
@WebServlet("/pages/LoadModificarKit")
public class LoadModificarKit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadModificarKit() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/pages/verModificarKits.jsp").forward(request, response);
	}
