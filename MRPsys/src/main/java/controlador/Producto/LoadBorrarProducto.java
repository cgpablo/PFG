 ...
 */
@WebServlet("/pages/LoadBorrarProducto")
public class LoadBorrarProducto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadBorrarProducto() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/pages/verBorrarProductos.jsp").forward(request, response);
	}
