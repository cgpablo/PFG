 ...
 */
@WebServlet("/pages/LoadBorrarMaterial")
public class LoadBorrarMaterial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadBorrarMaterial() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/pages/verBorrarMateriales.jsp").forward(request, response);
	}
