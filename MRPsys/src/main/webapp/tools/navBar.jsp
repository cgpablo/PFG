	...
	<!-- Navigation -->
      ...
      style="margin-bottom: 0">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="${pageContext.request.contextPath}/pages/main.jsp">iLineMRPsys</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <li class="dropdown">
              ...
              <li>
                <a href="${pageContext.request.contextPath}/pages/VerUsuarios"><i class="fa fa-table fa-fw"></i>Ver Users</a>
              </li>
              <li>
                <a href="${pageContext.request.contextPath}/pages/LoadModificarUsuario"><i class="fa fa-edit fa-fw"></i>Modificar Usuario</a>
              </li>
              <li>
                <a href="${pageContext.request.contextPath}/pages/LoadBorrarUsuario"><i class="fa fa-sign-out fa-fw"></i>Borrar Usuario</a>
              </li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="nav" id="side-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="nav nav-second-level">
                  ...
                  <li>
                    <a href="${pageContext.request.contextPath}/pages/VerPedidos"><i class="fa fa-table fa-fw"></i>Ver Pedidos por Usuario</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="${pageContext.request.contextPath}/pages/LoadCalcularPedido"><i class="fa fa-gear fa-fw"></i>Calcular aprovisionamiento</a>
                  </li>
                </ul>
              </li>
              <li class="dropdown">
                ...
                <ul class="nav nav-second-level">
                  ...
                  <li>
                    <a href="${pageContext.request.contextPath}/pages/LoadAddArticuloKit"><i class="fa fa-files-o fa-fw"></i>Añadir artículo a kit</a>
                  </li>
                  <li>
