   ...
   <body>
      <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                  <h1 class="page-header">Borrar Pedido</h1>
               </div>
               <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><%=p.getOrden()%></td>
                                    <td>
										<form method="POST" action="${pageContext.request.contextPath}/pages/BorrarPedido">
											<input type="hidden" name="referenciaPedido" value="<%=p.getReferenciaPedido() %>">
