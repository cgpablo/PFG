   ...
   <body>
      <div id="wrapper">
         ...
         <div id="page-wrapper">
            <div class="row">
               <div class="col-lg-12">
                  <h1 class="page-header">Borrar Kit</h1>
               </div>
               <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                           ...
                           <table class="table">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><%=k.getUdMat()%></td>
                                    <td>
										<form method="POST" action="${pageContext.request.contextPath}/pages/BorrarKit">
											<input type="hidden" name="referenciaKit" value="<%=k.getReferencia() %>">
